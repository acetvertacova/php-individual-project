...
require_once '../src/handlers/crudWithBooks/create.php';
?>
...
<body class="bg-[#fffaf3] py-10 font-sans">
    ...
    <div class="max-w-3xl mx-auto px-6">
        ...
        <h2 class="text-4xl font-bold text-[#6e4f3a] mb-10 text-center">📖 Add a New Book</h2>
        ...
        <form method="POST" enctype="multipart/form-data" class="bg-[#fffaf3] border border-[#f1e4d1] p-8 rounded-2xl shadow-md hover:shadow-lg transition duration-300 ease-in-out space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    class="w-full p-3 border border-[#e2d6c3] rounded-xl focus:ring-2 focus:ring-[#a38e74] focus:outline-none resize-none bg-[#fdf8f2]"></textarea>
                ...
                <div class="flex items-center gap-6">
                    <label class="inline-flex items-center">
                        <input type="radio" name="available" value="yes"
                            class="text-[#a38e74] focus:ring-[#a38e74]" required>
